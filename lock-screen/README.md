![lock-screen](.assets/Logo.png)

A linux rice inspired by the lock-screen (Central Operating System) from the Watch Dogs universe ([Disclaimer](#legal)). Components are modular so you can pick and choose what you would like to use, see project readmes for more details on each project.
...
This project is a non-commercial, fan-made tribute. The **lock-screen** name, branding, and logos are trademarks and/or copyrights of **Ubisoft Entertainment**.
