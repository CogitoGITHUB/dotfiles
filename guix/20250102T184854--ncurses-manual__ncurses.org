#+title:      NCURSES Manual
#+date:       [2025-01-02 Thu 18:48]
#+filetags:   :ncurses:
#+identifier: 20250102T184854
...
When user editing requests are processed by the forms driver
When the current page is changed by set_current_field() call
When the current field is changed by a set_form_page() call
