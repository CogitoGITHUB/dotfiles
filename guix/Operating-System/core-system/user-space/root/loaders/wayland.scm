(define-module (core-system user-space root loaders wayland)
  ...
  #:use-module (core-system user-space root desktop wayland cliphist)
  ...
  #:re-export (wl-clipboard cliphist grim slurp swaylock wlogout grimblast swappy)
  #:export (root-desktop-wayland-packages))

(define-public root-desktop-wayland-packages
  (list wl-clipboard cliphist grim slurp swaylock wlogout grimblast swappy))
