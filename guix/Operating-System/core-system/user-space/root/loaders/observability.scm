...
(define-module (core-system user-space root loaders observability)
  ...
  #:use-module (core-system user-space root observability services grafana)
  #:use-module (core-system user-space root observability services prometheus)
  ...
  #:export (root-observability-services))

(define-public root-observability-services
  (list
