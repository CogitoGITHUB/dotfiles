...
(define-module (core-system user-space root grafana-stack sops services sops)
  #:use-module (gnu)
  ...
  #:use-module (core-system user-space root grafana-stack sops services configuration)
  #:use-module (core-system user-space root grafana-stack sops build activation)
  #:use-module (core-system user-space root grafana-stack sops activation)
  ...
  #:use-module (core-system user-space root grafana-stack sops validation)
...
(define (sops-secrets-activation config)
  ...
  (with-imported-modules (source-module-closure
                            '((core-system user-space root grafana-stack sops build activation))
