...
(define-module (core-system user-space root grafana-stack oci services grafana)
  ;; gnu packages admin - only available in guix system context
  ...
  #:use-module (core-system user-space root grafana-stack oci build utils)
