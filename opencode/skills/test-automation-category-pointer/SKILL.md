---
name: test-automation-category-pointer
description: "Pointer to a library of 9 specialized Test Automation skills. Use when working on test-automation-related tasks."
risk: safe
---

# Test Automation Capability Library 🎯

This is a **pointer skill**. The 9 specialized Test Automation skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/test-automation/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/test-automation`
