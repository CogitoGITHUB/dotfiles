...
description: "Pointer to a library of 13 specialized Data Ai skills. Use when working on data-ai-related tasks."
risk: safe
---

# Data Ai Capability Library 🎯

This is a **pointer skill**. The 13 specialized Data Ai skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/data-ai/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/data-ai`
