---
name: front-end-category-pointer
description: "Pointer to a library of 14 specialized Front End skills. Use when working on front-end-related tasks."
risk: safe
---

# Front End Capability Library 🎯

This is a **pointer skill**. The 14 specialized Front End skills are stored in a hidden vault to keep your startup context minimal.
...
- **scroll-experience** — Expert in building immersive scroll-driven experiences - parallax storytelling, scroll animations, interactive narratives, and cinematic web experiences. Like NY Times interactives, Apple product pages, and award-winning web experiences.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/front-end/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/front-end`
