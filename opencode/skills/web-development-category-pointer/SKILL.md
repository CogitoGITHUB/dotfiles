---
name: web-development-category-pointer
description: "Pointer to a library of 44 specialized Web Development skills. Use when working on web-development-related tasks."
risk: safe
---

# Web Development Capability Library 🎯

This is a **pointer skill**. The 44 specialized Web Development skills are stored in a hidden vault to keep your startup context minimal.
...
- **browser-extension-builder** — Expert in building browser extensions that solve real problems - Chrome, Firefox, and cross-browser extensions. Covers extension architecture, manifest v3, content scripts, popup UIs, monetization strategies, and Chrome Web Store publishing.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/web-development/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/web-development`
