---
name: granular-workflow-bundle-category-pointer
description: "Pointer to a library of 16 specialized Granular Workflow Bundle skills. Use when working on granular-workflow-bundle-related tasks."
risk: safe
---

# Granular Workflow Bundle Capability Library 🎯

This is a **pointer skill**. The 16 specialized Granular Workflow Bundle skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/granular-workflow-bundle/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/granular-workflow-bundle`
