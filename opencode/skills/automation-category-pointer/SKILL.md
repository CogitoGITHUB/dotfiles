...
description: "Pointer to a library of 44 specialized Automation skills. Use when working on automation-related tasks."
risk: safe
---

# Automation Capability Library 🎯

This is a **pointer skill**. The 44 specialized Automation skills are stored in a hidden vault to keep your startup context minimal.
...
- **zapier-make-patterns** — No-code automation democratizes workflow building. Zapier and Make (formerly Integromat) let non-developers automate business processes without writing code. But no-code doesn't mean no-complexity - these platforms have their own patterns, pitfalls, and breaking points.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/automation/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/automation`
