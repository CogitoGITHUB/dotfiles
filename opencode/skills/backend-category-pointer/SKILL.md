---
name: backend-category-pointer
description: "Pointer to a library of 28 specialized Backend skills. Use when working on backend-related tasks."
risk: safe
---

# Backend Capability Library 🎯

This is a **pointer skill**. The 28 specialized Backend skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/backend/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/backend`
