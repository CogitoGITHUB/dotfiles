---
name: architecture-category-pointer
description: "Pointer to a library of 25 specialized Architecture skills. Use when working on architecture-related tasks."
risk: safe
---

# Architecture Capability Library 🎯

This is a **pointer skill**. The 25 specialized Architecture skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/architecture/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/architecture`
