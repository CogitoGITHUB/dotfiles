---
name: game-development-category-pointer
description: "Pointer to a library of 16 specialized Game Development skills. Use when working on game-development-related tasks."
risk: safe
---

# Game Development Capability Library 🎯

This is a **pointer skill**. The 16 specialized Game Development skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/game-development/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/game-development`
