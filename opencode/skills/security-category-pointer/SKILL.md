---
name: security-category-pointer
description: "Pointer to a library of 73 specialized Security skills. Use when working on security-related tasks."
risk: safe
---

# Security Capability Library 🎯

This is a **pointer skill**. The 73 specialized Security skills are stored in a hidden vault to keep your startup context minimal.
...
- **file-uploads** — Expert at handling file uploads and cloud storage. Covers S3, Cloudflare R2, presigned URLs, multipart uploads, and image optimization. Knows how to handle large files without blocking.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/security/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/security`
