---
name: graphics-processing-category-pointer
description: "Pointer to a library of 5 specialized Graphics Processing skills. Use when working on graphics-processing-related tasks."
risk: safe
---

# Graphics Processing Capability Library 🎯

This is a **pointer skill**. The 5 specialized Graphics Processing skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/graphics-processing/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/graphics-processing`
