...
description: "Pointer to a library of 21 specialized Mobile skills. Use when working on mobile-related tasks."
risk: safe
---

# Mobile Capability Library 🎯

This is a **pointer skill**. The 21 specialized Mobile skills are stored in a hidden vault to keep your startup context minimal.
...
2. Use `view_file` to read its `SKILL.md` from the vault:
   `/home/aoeu/.config/opencode/skill-libraries/mobile/<skill-name>/SKILL.md`
3. Follow those instructions to complete the request.

**Vault path:** `/home/aoeu/.config/opencode/skill-libraries/mobile`
