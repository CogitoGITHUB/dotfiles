...
(sudo nixos-rebuild test --flake .#shapeless > /tmp/nixos-test.log 2>&1 && notify-send "NixOS" "✅ Test passed!" --urgency=normal || notify-send "NixOS" "❌ Test failed!" --urgency=critical) &
disown
