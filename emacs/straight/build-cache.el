...
(fn &optional FILENAMES BUFFER-NAME DISPLAY-P)" t) (register-definition-prefixes "pdf-virtual" '("pdf-virtual-")) (provide 'pdf-tools-autoloads)) "universal-launcher" ((universal-launcher-autoloads universal-launcher) (register-definition-prefixes "universal-launcher" '("universal-launcher-")) (provide 'universal-launcher-autoloads)) "all-the-icons" ((all-the-icons-autoloads all-the-icons-faces all-the-icons) (autoload 'all-the-icons-icon-for-dir "all-the-icons" "Get the formatted icon for DIR.
...
(fn &optional ARG FAMILY)" t) (register-definition-prefixes "all-the-icons" '("all-the-icons-")) (provide 'all-the-icons-autoloads)) "all-the-icons-dired" ((all-the-icons-dired-autoloads all-the-icons-dired) (autoload 'all-the-icons-dired-mode "all-the-icons-dired" "Display all-the-icons icon for each file in a Dired buffer.
...
(fn &optional ARG)" t) (register-definition-prefixes "all-the-icons-completion" '("all-the-icons-completion-completion-metadata-get")) (provide 'all-the-icons-completion-autoloads)) "embark" ((embark embark-autoloads embark-org) (defun embark--record-this-command nil "Record command which opened the minibuffer.
...
(fn &optional ARG)" t) (register-definition-prefixes "org-roam-ui" '("img/:file" "node/:id" "org-roam-ui-")) (provide 'org-roam-ui-autoloads)) "olivetti" ((olivetti olivetti-autoloads) (autoload 'olivetti-mode "olivetti" "Olivetti provides a nice writing environment.
...
(fn &optional ARG)" t) (register-definition-prefixes "olivetti" '("olivetti-")) (provide 'olivetti-autoloads)) "orgit" ((orgit-autoloads orgit) (with-eval-after-load 'magit (keymap-set magit-mode-map "<remap> <org-store-link>" #'orgit-store-link)) (autoload 'orgit-store-link "orgit" "Like `org-store-link' but store links to all selected commits, if any.
...
(fn &optional ARG)") (register-definition-prefixes "orgit" '("orgit-")) (provide 'orgit-autoloads)) "orgit-file" ((orgit-file orgit-file-autoloads) (with-eval-after-load 'org (with-eval-after-load 'magit (org-link-set-parameters "orgit-file" :store #'orgit-file-store :follow #'orgit-file-open :export #'orgit-file-export :complete #'orgit-file-complete-link))) (autoload 'orgit-file-store "orgit-file" "Store link to file in current Magit buffer.
...
Return non-nil if link was stored." t) (autoload 'orgit-file-open "orgit-file" "Open orgit-file link at PATH.
...
(fn PATH)") (autoload 'orgit-file-export "orgit-file" "Export orgit-file link at PATH to web URL if possible.
...
(fn PATH DESC FORMAT)") (autoload 'orgit-file-complete-link "orgit-file" "Complete orgit-file link with repository, revision, and file selection.
...
(fn &optional ARG)") (autoload 'orgit-file-export-link-at-point "orgit-file" "Export orgit-file link at point and copy result to kill ring.
...
(fn &optional FORMAT)" t) (register-definition-prefixes "orgit-file" '("orgit-file-")) (provide 'orgit-file-autoloads)) "speed-type" ((test-speed-type speed-type-autoloads speed-type) (autoload 'speed-type-text-top-x "speed-type" "Speed type the N most common words.

(fn X)" t) (autoload 'speed-type-top-x "speed-type" "Speed type the N most common words.

(fn X)" t) (autoload 'speed-type-top-100 "speed-type" "Speed type the top 100 most common words." t) (autoload 'speed-type-top-1000 "speed-type" "Speed type the top 1000 most common words." t) (autoload 'speed-type-region "speed-type" "Open copy of [START,END] in a new buffer to speed type the text.

(fn START END)" t) (autoload 'speed-type-buffer-top-x "speed-type" "Calculate a frequency list of CURRENT-BUFFER and assemble typing-text from top-X-words.

(fn X)" t) (autoload 'speed-type-buffer "speed-type" "Open copy of buffer contents in a new buffer to speed type the text.

If using a prefix while calling this function `C-u', then the FULL text
will be used.  Else some text will be picked randomly.

(fn FULL)" t) (autoload 'speed-type-text "speed-type" "Setup a new text sample to practice touch or speed typing." t) (autoload 'speed-type-quotes "speed-type" "Setup a new quote to practice touch or speed typing.

If `ARG' is given will prompt for a specific quote-URL.

(fn &optional ARG)" t) (autoload 'speed-type-continue "speed-type" "Searches the last position of the file opened by this buffer and setup a speed-type-session continuing at that last found position. If nothing is found, will begin at 0.
